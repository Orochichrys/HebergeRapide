            ...
            <div>
              <div className="flex gap-4 mb-4">
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2 ${mode === 'editor' ? 'bg-brand-500 text-white' : 'bg-dark-bg text-gray-400 hover:text-white'
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2 ${mode === 'upload' ? 'bg-brand-500 text-white' : 'bg-dark-bg text-gray-400 hover:text-white'
                    }`}
                >
...
<html>
  <body>
    <h1>Bonjour le monde!</h1>
                ...
                <div className="h-[300px] border-2 border-dashed border-dark-border rounded-lg flex flex-col items-center justify-center text-gray-400 hover:border-brand-500 hover:bg-dark-bg/50 transition-all relative">
                  <input
                    type="file"
          ...
          <div className="bg-dark-bg rounded-lg p-6 border border-dark-border flex flex-col">
            ...
            {!analysis && !isAnalyzing && (
              <div className="text-center text-gray-500 flex-1 flex flex-col items-center justify-center">
                <div className="bg-dark-card w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            {isAnalyzing && (
              <div className="space-y-4 animate-pulse flex-1">
                ...
                <div className="h-4 bg-dark-card rounded w-1/2"></div>
                <div className="h-32 bg-dark-card rounded w-full"></div>
              </div>
            )}
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    {analysis.suggestions.map((sug, idx) => (
                      <li key={idx} className="flex gap-3 text-sm text-gray-300 bg-dark-card/50 p-2 rounded">
