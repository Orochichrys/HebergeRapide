              ...
              <div className="flex gap-4 mb-4">
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2 ${
                    mode === 'editor' ? 'bg-brand-500 text-white' : 'bg-dark-bg text-gray-400 hover:text-white'
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2 ${
                    mode === 'upload' ? 'bg-brand-500 text-white' : 'bg-dark-bg text-gray-400 hover:text-white'
                  }`}
                >
